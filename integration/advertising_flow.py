...
import integration.advertising_data_model as dm
from integration.advertising_data_source import DataSource
...
def get_data_from_source():
    ...
    source_api = DataSource(           
        token=cfg.SRC_TOKEN,
        url_advertising=cfg.SRC_URL_GET_ADVERTISING_VS_CUSTOMER,
        url_advertising_summary=cfg.SRC_URL_GET_ADVERTISING_SUMMARY            
    )
...
if __name__ == '__main__':
    ...
    smTaskUtil = sm.SmTaskUtil(reference_id=args.reference_id, task_name=cfg.TASK2_ADVERTISING_CODE, test_mode=False)
